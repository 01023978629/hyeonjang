...
# 3) 전체 회귀 — 권위 있는 집계는 tests/run-all.js 가 찍는 'N개 중 N 통과' (2026-09-06 기준 116개)
...
- 현재 전체 회귀 기준은 `tests/run-all.js`가 집계하는 파일 전부(2026-09-06 현재 116개)다. 과거의 브라우저·정적 60개 집계는
