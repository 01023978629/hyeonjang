...
> 2026-08-23 기준. 낡은 내용을 발견하면 **이 문서부터 고쳐라.**
...
현재 기준선은 `hyeonjang-v231-officeintakefix`이며 기존 검사는 78개다. 사진 동기화 로컬 후보
...
- 기준선은 `hyeonjang-v231-officeintakefix`이며 기존 검사 78개가 통과했다. v231은 관리사무소 접수의 공개 보고 수정·철회와 충돌 복구를 포함한다.
