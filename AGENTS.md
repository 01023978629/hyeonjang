...
현재 기준선은 `hyeonjang-v232-officeintakesafety`이며 기존 검사는 78개다. 사진 동기화 로컬 후보
...
- 기준선은 `hyeonjang-v232-officeintakesafety`이며 기존 검사 78개가 통과했다. v232는 관리사무소 접수의 공개 보고 수정·철회, 명시 프로젝트 사진 소유권, revision·충돌 복구를 포함한다.
