...
운영 기준선은 main 의 최신 버전(2026-09-07 현재 `hyeonjang-v262-searchrecovery`)이며 전체 회귀는
`tests/run-all.js`가 집계하는 117개다(모바일 사진 후보는 118개 — 러너 마지막 줄의 집계를 믿어라). 사진 동기화 로컬 후보
...
모바일 사진 후보 `hyeonjang-v263-photointake`는 갤러리·촬영 뒤 현장/작업명 확인,
...
실제 휴대폰 카메라/갤러리와 운영 서버 업로드는 대표 실기기 확인 대상. v263은 별도 배포 승인 전 미배포다.
